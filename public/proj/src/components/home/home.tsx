...
//parent(relative)
//image(relative)  << allows parent to scale with the size of the image
//text(absolute)   <<< Text is positioned relative to parent relative which expands with image. 
...
export default class Home extends React.Component<{}, {}> {
    render() {
        return (
            <div className="home">
                <header>
                    <video src="./images/flow_in_the_sky.mp4" loop="yes" muted="yes" autoPlay="yes"/>
                    <div className="abs">
                        <h1>
                            Web Dev and Me
                        </h1>
